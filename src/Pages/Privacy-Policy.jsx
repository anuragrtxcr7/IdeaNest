  ...
  return (
    <div>
      <div className="container mx-auto py-8 px-4 sm:px-2">
        ...
        <p className="mb-4">
          This privacy policy sets out how IdeaNest uses and protects any
        ...
        <p className="mb-4">
          IdeaNest may use cookies to enhance user experience. By using IdeaNest,
        ...
        <p className="mb-4">
          IdeaNest may contain links to other websites. Please note that we have
